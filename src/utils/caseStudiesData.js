  ...
  export const cases = [
    {
      ...
      challenges: [
        ...
        "Resolving incorrect event configurations and dimensions that impacted data accuracy.",
      ],
      approach: [
        "Implement comprehensive e-commerce tracking to monitor critical user actions like plan purchases, content subscriptions, and engagement metrics.",
        "Deployed tools and tagging methods to capture marketing attribution data, aligning with Watcho's campaign strategy for accurate tracking and reporting.",
        "Identified and corrected incorrectly configured events and dimensions, ensuring clean and reliable data collection for analysis.",
      ],
      outcomes: [
        {
          value: "150%",
          desc: "Improved Marketing ROI",
        },
        {
          value: "180%",
          desc: "Increased Plan Subscriptions",
        },
        {
          value: "30%",
